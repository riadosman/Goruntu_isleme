...
while cap.isOpened():
  ...
  if results.face_landmarks:
        ...
        # cv2.putText(frame, f"{avg_ear > 0.3 ? "Goz Aciktir" : "Goz kapalidir"}", (30, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0,0,255), 2)

        if avg_ear > 0.3:
          cv2.putText(frame, "Goz Aciktir", (30, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0,255,0), 2)
        else:
          cv2.putText(frame, "Goz Kapalidir", (30, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0,0,255), 2)
